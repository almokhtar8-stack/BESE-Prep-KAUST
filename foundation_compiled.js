...
const domains = [{
  ...
  subtitle: "The biological foundation",
  color: "#10B981",
  bg: "#10B98112",
  border: "#10B98130",
  level: "FOUNDATION",
  description: "Master the core language of modern biology. Without this, everything else (sequencing, computation, AI) loses its meaning. Start here.",
  tracks: [{
    ...
    resources: [{
      ...
      note: "Free via NCBI. The standard reference. Ch. 1–8 minimum."
    }, {
      title: "MIT OCW 7.016 Introductory Biology",
      type: "Course",
      free: true,
      url: "https://ocw.mit.edu/courses/7-016-introductory-biology-fall-2018/",
      note: "Full lecture series. Watch at 1.5×. Rigorous but accessible."
    }, {
      title: "Crash Course Biology (YouTube)",
      type: "Video",
      free: true,
      url: "https://www.youtube.com/playlist?list=PL3EED4C1D684D3ADF",
      note: "Fast revision of core concepts. Great for gaps."
    }],
    ...
    effort: "~4h/week",
    resources: [{
      title: "Introduction to Genomics - Coursera (Johns Hopkins)",
      type: "Course",
      free: true,
      url: "https://www.coursera.org/learn/introduction-genomics",
      note: "Audit for free. Covers sequencing, variant calling, population genetics."
    }, {
      title: "Lewin's Genes XII",
      type: "Textbook",
      free: false,
      url: "https://www.amazon.com/Lewins-Genes-XII-Jocelyn-Krebs/dp/1284104494",
      note: "Focus on gene regulation and epigenetics chapters."
    }, {
      title: "Khan Academy Genetics",
      type: "Free",
      free: true,
      url: "https://www.khanacademy.org/science/ap-biology/heredity",
      note: "Excellent for solidifying inheritance and Mendelian foundations."
    }],
    ...
    effort: "~4h/week",
    resources: [{
      title: "Orchestrating Single-Cell Analysis (OSCA)",
      type: "Free Book",
      free: true,
      url: "https://bioconductor.org/books/release/OSCA/",
      note: "The definitive scRNA-seq reference. Bioconductor-based. Bookmark this."
    }, {
      title: "Hemberg Lab scRNA-seq Course",
      type: "Course",
      free: true,
      url: "https://www.singlecellcourse.org/",
      note: "Theory + practice combined. Excellent structure."
    }, {
      title: "Current Best Practices in scRNA-seq (Luecken & Theis 2019)",
      type: "Paper",
      free: true,
      url: "https://www.embopress.org/doi/full/10.15252/msb.20188746",
      note: "Essential reading - outlines the full analysis pipeline."
    }],
  ...
  emoji: "∑",
  title: "Mathematics",
  subtitle: "The hidden engine",
  color: "#6366F1",
  bg: "#6366F112",
  border: "#6366F130",
  level: "CRITICAL",
  description: "Most bioinformatics mistakes happen because researchers don't understand the math in their tools. Linear algebra, probability, and statistics are non-negotiable.",
  tracks: [{
    name: "Linear Algebra",
    timeframe: "Weeks 1–4",
    effort: "~3h/week",
    resources: [{
      ...
      note: "The best visual intuition available. Watch before anything else."
    }, {
      title: "MIT 18.06 Linear Algebra - Gilbert Strang",
      type: "Course",
      free: true,
      url: "https://ocw.mit.edu/courses/18-06-linear-algebra-spring-2010/",
      note: "Gold standard. Full lectures + problem sets. Free via MIT OCW."
    }, {
      title: "Immersive Linear Algebra (interactive textbook)",
      type: "Free",
      free: true,
      url: "http://immersivemath.com/ila/index.html",
      note: "Interactive, visual companion - especially good for eigenvectors."
    }],
    ...
    resources: [{
      ...
      note: "Bioinformatics-specific stats explained with extraordinary clarity. Essential."
    }, {
      title: "Probability for Data Science - UC Berkeley Prob140",
      type: "Free Book",
      free: true,
      url: "http://prob140.org/textbook/content/README.html",
      note: "Rigorous Bayesian foundations. Free online textbook."
    }, {
      title: "An Introduction to Statistical Learning (ISLR)",
      type: "Free Book",
      free: true,
      url: "https://www.statlearning.com/",
      note: "Canonical ML+stats reference. Free PDF. R and Python editions."
    }],
    ...
    resources: [{
      ...
      note: "Build intuition before formulas. Watch all 11 episodes."
    }, {
      title: "Khan Academy Multivariable Calculus",
      type: "Free",
      free: true,
      url: "https://www.khanacademy.org/math/multivariable-calculus",
      note: "Gradients and partial derivatives matter for ML theory."
    }, {
      title: "Convex Optimization - Boyd & Vandenberghe",
      type: "Free Book",
      free: true,
      url: "https://web.stanford.edu/~boyd/cvxbook/",
      note: "Free PDF. Foundational for understanding ML objective functions."
    }],
  ...
  border: "#F43F5E30",
  level: "STRATEGIC",
  description: "Modern biology is inseparable from ML. You need to understand models well enough to choose them, critique them, and build on them - not just run pipelines.",
  tracks: [{
    ...
    resources: [{
      ...
      note: "Top-down, code-first approach. Best for people who learn by doing."
    }, {
      title: "Machine Learning Specialization - Andrew Ng (Coursera)",
      type: "Course",
      free: true,
      url: "https://www.coursera.org/specializations/machine-learning-introduction",
      note: "Audit free. Broad foundations, excellent explanations."
    }, {
      title: "An Introduction to Statistical Learning (ISLR)",
      type: "Free Book",
      free: true,
      url: "https://www.statlearning.com/",
      note: "Overlaps with stats track - read the ML chapters here."
    }],
    ...
    resources: [{
      ...
      note: "Covers CNNs, RNNs, and transformers. Audit free."
    }, {
      title: "The Annotated Transformer (Harvard NLP)",
      type: "Tutorial",
      free: true,
      url: "https://nlp.seas.harvard.edu/2018/04/03/attention.html",
      note: "Line-by-line implementation of the transformer. Understand attention deeply."
    }, {
      title: "Dive into Deep Learning (d2l.ai)",
      type: "Free Book",
      free: true,
      url: "https://d2l.ai/",
      note: "Interactive. PyTorch throughout. Excellent for hands-on learners."
    }],
    ...
    effort: "~4h/week",
    resources: [{
      title: "Causal Inference: The Mixtape - Cunningham",
      type: "Free Book",
      free: true,
      url: "https://mixtape.scunning.com/",
      note: "Accessible causal inference. Critical for interpreting biological experiments."
    }, {
      title: "scVI paper - Lopez et al. 2018 (Nature Methods)",
      type: "Paper",
      free: true,
      url: "https://www.nature.com/articles/s41592-018-0229-2",
      note: "Variational autoencoders for scRNA-seq. Foundational in the field."
    }, {
      title: "AlphaFold2 paper (Jumper et al. 2021)",
      type: "Paper",
      free: true,
      url: "https://www.nature.com/articles/s41586-021-03819-2",
      note: "Read to understand how DL redefined structural biology."
    }],
  ...
  subtitle: "Your laboratory tools",
  color: "#F59E0B",
  bg: "#F59E0B12",
  border: "#F59E0B30",
  level: "CORE",
  description: "Code is the lab bench of computational biology. Python and R are equally important. Reproducibility is not optional; it's professional hygiene.",
  tracks: [{
    ...
    resources: [{
      ...
      note: "NumPy, SciPy, matplotlib: the scientific stack. Essential reference."
    }, {
      title: "The Missing Semester of CS - MIT",
      type: "Course",
      free: true,
      url: "https://missing.csail.mit.edu/",
      note: "Shell, Git, editors, debugging. Every researcher needs this."
    }, {
      title: "Snakemake Tutorial",
      type: "Tutorial",
      free: true,
      url: "https://snakemake.readthedocs.io/en/stable/tutorial/tutorial.html",
      note: "Reproducible bioinformatics pipelines. Expected in any serious lab."
    }],
    ...
    resources: [{
      ...
      note: "Learn tidyverse properly. Non-negotiable if you'll use Bioconductor."
    }, {
      title: "RNA-seq workflow - Bioconductor (limma/DESeq2)",
      type: "Tutorial",
      free: true,
      url: "https://bioconductor.org/packages/release/workflows/vignettes/RNAseq123/inst/doc/limmaWorkflow.html",
      note: "Lab-standard differential expression analysis pipeline."
    }, {
      title: "Data Analysis for Life Sciences - Irizarry & Love",
      type: "Free",
      free: true,
      url: "https://rafalab.github.io/pages/harvardx.html",
      note: "Free HarvardX course series. R-based. World-class instructors."
    }],
    ...
    resources: [{
      ...
      note: "Hands-on, biology-focused. Workshop-style. Free online."
    }, {
      title: "Introduction to SLURM (HPC job scheduler)",
      type: "Tutorial",
      free: true,
      url: "https://slurm.schedmd.com/quickstart.html",
      note: "Most university and institute clusters use SLURM. Learn this before you arrive."
    }, {
      title: "Docker for Bioinformatics - BioContainers",
      type: "Tutorial",
      free: true,
      url: "https://biocontainers.pro/",
      note: "Containerization = reproducibility. Required for serious pipelines."
    }],
  ...
  subtitle: "Your voice in the field",
  color: "#06B6D4",
  bg: "#06B6D412",
  border: "#06B6D430",
  level: "HIGH",
  description: "Most researchers write poorly because they were never taught. A clear, precise scientific paper is a skill that can be learned systematically, and it dramatically affects your career.",
  tracks: [{
    name: "Reading Papers Efficiently",
    ...
    resources: [{
      ...
      note: "2-page guide. The 3-pass method. Read this today, before anything else."
    }, {
      title: "Connected Papers",
      type: "Tool",
      free: true,
      url: "https://www.connectedpapers.com/",
      note: "Visualize citation networks around key papers in your field."
    }, {
      title: "Semantic Scholar",
      type: "Tool",
      free: true,
      url: "https://www.semanticscholar.org/",
      note: "Set citation alerts for key authors. Stay current automatically."
    }],
    ...
    name: "Paper Structure & Prose",
    timeframe: "Weeks 6–10",
    effort: "~3h/week",
    resources: [{
      title: "Writing in the Sciences - Coursera (Stanford)",
      type: "Course",
      free: true,
      url: "https://www.coursera.org/learn/sciwrite",
      note: "Kristin Sainani's course. Transformative. The single best writing course for scientists."
    }, {
      title: "The Craft of Scientific Writing - Michael Alley",
      type: "Textbook",
      free: false,
      url: "https://www.amazon.com/Craft-Scientific-Writing-Michael-Alley/dp/1441982876",
      note: "Authoritative reference. Focus on clarity and precision."
    }, {
      title: "Nature: How to write a first-class paper",
      type: "Free",
      free: true,
      url: "https://www.nature.com/articles/d41586-018-02404-4",
      note: "Direct advice from Nature editors. Short and worth reading."
    }],
    ...
    name: "Reference Management & Submission",
    timeframe: "Weeks 2–4 (setup) + ongoing",
    effort: "~1h/week",
    resources: [{
      ...
      note: "Start your literature database now. Organize by topic/project from day 1."
    }, {
      title: "EQUATOR Network - Reporting Guidelines",
      type: "Resource",
      free: true,
      url: "https://www.equator-network.org/",
      note: "STROBE, CONSORT, MIQE: know the reporting standard for your study type."
    }, {
      title: "bioRxiv Preprint Server",
      type: "Resource",
      free: true,
      url: "https://www.biorxiv.org/",
      note: "Preprints are standard in biology now. Understand the workflow."
    }],
  ...
  subtitle: "How science actually works",
  color: "#EC4899",
  bg: "#EC489912",
  border: "#EC489930",
  level: "HIGH",
  description: "Domain knowledge alone doesn't make a researcher. The meta-skills (designing experiments, presenting findings, asking the right question) are what separate contributors from consumers.",
  tracks: [{
    name: "Experiment Design & Hypothesis",
    timeframe: "Weeks 4–7",
    effort: "~2h/week",
    resources: [{
      title: "Experimental Design in Biology - HHMI BioInteractive",
      type: "Free",
      free: true,
      url: "https://www.biointeractive.org/classroom-resources/experimental-design-biology",
      note: "Visual, rigorous, accessible. Covers controls, variables, and reproducibility."
    }, {
      title: "Think Bayes - Allen Downey",
      type: "Free Book",
      free: true,
      url: "https://greenteapress.com/wp/think-bayes/",
      note: "Bayesian thinking applied to real experimental reasoning."
    }, {
      title: "How to Design a Good Experiment - Nature Methods",
      type: "Free",
      free: true,
      url: "https://www.nature.com/articles/nmeth.2613",
      note: "Brief but authoritative guidance on statistical power and sample size."
    }],
    ...
    resources: [{
      ...
      note: "Master Boolean operators and MeSH terms. Systematic searching is a skill."
    }, {
      title: "Rayyan - Systematic Review Tool",
      type: "Tool",
      free: true,
      url: "https://www.rayyan.ai/",
      note: "Free for researchers. Collaborate on abstract screening."
    }, {
      title: "Ten Simple Rules for Writing a Literature Review - PLoS",
      type: "Free",
      free: true,
      url: "https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003149",
      note: "Practical checklist for structuring a review paper."
    }],
    ...
    effort: "~2h/week",
    resources: [{
      title: "Ten Simple Rules for Oral Presentations - PLoS Comp Bio",
      type: "Free",
      free: true,
      url: "https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.0030077",
      note: "For journal clubs and lab meetings. Short, direct rules."
    }, {
      title: "Better Posters Blog - Zen Faulkes",
      type: "Blog",
      free: true,
      url: "https://betterposters.blogspot.com/",
      note: "Conference poster design principles."
    }, {
      title: "Fundamentals of Data Visualization - Claus Wilke",
      type: "Free Book",
      free: true,
      url: "https://clauswilke.com/dataviz/",
      note: "Free online. The standard reference for scientific figure design."
    }],
...
const phases = [{
  ...
  items: ["Cell Biology fundamentals", "Linear Algebra (3B1B)", "Python scientific stack", "Read 2 papers/week (start now)", "Set up Zotero"]
}, {
  range: "Weeks 5-8",
  title: "Expand the Framework",
  items: ["Genetics & Genomics", "Probability & Statistics (StatQuest)", "R + Bioconductor basics", "ML Foundations", "Scientific writing course begins"]
}, {
  range: "Weeks 9-12",
  title: "Go Deeper",
  items: ["Single-cell transcriptomics", "Deep Learning", "SLURM & HPC basics", "Paper structure & prose", "Experiment design principles"]
}, {
  range: "Weeks 13-16",
  title: "Integrate & Apply",
  items: ["AI for Biology (causal inference, GNNs)", "Full scRNA-seq pipeline practice", "Presentation skills (lab talk)", "Draft or revise a preprint", "Literature review synthesis"]
}];
const arUI = {
  ...
  "phases": [{
    "range": "الأسابيع 1-4",
    "title": "ابنِ الأساس",
    "items": ["أساسيات أحياء الخلية", "الجبر الخطي (3B1B)", "حزمة Python العلمية", "اقرأ ورقتين بحثيتين أسبوعيًا (ابدأ الآن)", "إعداد Zotero"]
  }, {
    "range": "الأسابيع 5-8",
    "title": "وسّع الإطار",
    "items": ["علم الوراثة والجينوميات", "الاحتمالات والإحصاء (StatQuest)", "أساسيات R + Bioconductor", "أساسيات ML", "بدء دورة الكتابة العلمية"]
  }, {
    "range": "الأسابيع 9-12",
    "title": "تعمّق أكثر",
    "items": ["ترانسكريبتوميات الخلية الواحدة", "التعلم العميق", "أساسيات SLURM و HPC", "بنية الورقة البحثية والصياغة العلمية", "مبادئ تصميم التجارب"]
  }, {
    "range": "الأسابيع 13-16",
    "title": "ادمج وطبّق",
    "items": ["AI للأحياء (الاستدلال السببي، GNNs)", "تدريب كامل على مسار تحليل scRNA-seq", "مهارات العرض (عرض مختبري)", "صياغة أو مراجعة preprint", "توليف مراجعة الأدبيات"]
  }]
};
const arDomains = [{
  "id": "mol",
  ...
  "tracks": [{
    ...
    "skills": ["دورة الخلية ونقاط التفتيش", "تضاعف DNA وإصلاحه", "النسخ والترجمة", "مسارات الإشارة الخلوية", "بيولوجيا الأغشية والعضيات"]
  }, {
    ...
    "skills": ["الوراثة المندلية → الوراثة المعقدة", "علم التخلق وإعادة تشكيل الكروماتين", "مفاهيم SNP وindel وCNV", "شبكات تنظيم الجينات", "أساسيات GWAS والخطر متعدد الجينات"]
  }, {
    ...
    "skills": ["مفاهيم تحضير مكتبة 10x Chromium", "العنقدة وخفض الأبعاد", "تحليل الزمن الزائف والمسارات التطورية", "اختبار التعبير التفاضلي", "استراتيجيات توصيف أنواع الخلايا"]
  }]
}, {
  "id": "math",
  "emoji": "∑",
  ...
  "tracks": [{
    ...
    "skills": ["عمليات المصفوفات والتحليلات", "SVD وPCA (ضروريان لبيانات omics)", "القيم الذاتية والمتجهات الذاتية", "فضاءات المتجهات والإسقاطات", "حلول المربعات الصغرى"]
  }, {
    ...
    "skills": ["نظرية بايز والاستدلال اللاحق", "اختبار الفرضيات وقيم p", "تصحيح الاختبارات المتعددة (FDR، Bonferroni)", "نماذج الانحدار (خطي، لوجستي، Cox)", "التوزيعات ونظرية أخذ العينات"]
  }, {
    ...
    "skills": ["المشتقات والتدرجات", "قاعدة السلسلة (أساس الانتشار العكسي)", "المشتقات الجزئية ومصفوفات Jacobian", "التحسين بالانحدار التدرجي", "أساسيات التحسين المقيد"]
  }]
}, {
  "id": "ai",
  "emoji": "🤖",
  ...
  "tracks": [{
    ...
    "skills": ["التعلم الموجه مقابل غير الموجه", "التحقق المتقاطع والتنظيم", "أشجار القرار → طرق التجميع", "خفض الأبعاد (PCA، UMAP، t-SNE)", "مقاييس تقييم النماذج"]
  }, {
    ...
    "skills": ["الشبكات أمامية التغذية والمتكررة", "الشبكات الالتفافية للتسلسلات", "آلية الانتباه وبنية المحولات", "نقل التعلم والضبط الدقيق", "التنظيم والتطبيع بالدُفعات"]
  }, {
    "name": "AI للأحياء",
    ...
    "skills": ["الرسوم البيانية السببية DAGs ومنطق التدخل", "الشبكات العصبية الرسومية في الأحياء", "المشفّرات التلقائية التباينية (scVI، scANVI)", "مفاهيم التنبؤ بالبنية البروتينية", "نمذجة الاضطراب (CellOracle، SCENIC)"]
  }]
}, {
  "id": "code",
  "emoji": "⌨️",
  ...
  "tracks": [{
    ...
    "skills": ["الحوسبة المتجهة باستخدام NumPy", "Pandas للبيانات الجدولية", "دفاتر Jupyter قابلة لإعادة الإنتاج", "مسارات عمل Snakemake/Nextflow", "إدارة بيئات Conda"]
  }, {
    ...
    "skills": ["ggplot2 ورسوم بجودة النشر", "DESeq2 وedgeR للتعبير التفاضلي", "Seurat لتحليل scRNA-seq", "منظومة حزم Bioconductor", "R Markdown لتقارير قابلة لإعادة الإنتاج"]
  }, {
    "name": "HPC وLinux",
    "timeframe": "الأسابيع 4-8",
    ...
    "skills": ["برمجة Bash والأتمتة", "إرسال مهام SLURM ومراقبتها", "التحكم بالإصدارات والتعاون عبر Git", "حاويات Docker/Singularity", "tmux والعمل على الخوادم عن بعد"]
  }]
}, {
  "id": "writing",
  "emoji": "✍️",
  ...
  "tracks": [{
    ...
    "skills": ["طريقة القراءة بثلاث تمريرات", "تمييز المساهمة الحقيقية عن العمل التدريجي", "التقييم النقدي لأقسام المنهجية", "بناء مكتبة أدبيات مشروحة", "تلخيص الأوراق في 5 جمل"]
  }, {
    ...
    "skills": ["بنية IMRAD", "كتابة ملخصات مركزة", "تعليقات أشكال مفهومة بذاتها", "إزالة المبني للمجهول الزائد", "وضوح نسبة الادعاءات إلى الأدلة"]
  }, {
    ...
    "skills": ["Zotero للاقتباس أثناء الكتابة", "أنماط الاقتباس CSL", "الالتزام بإرشادات الإبلاغ", "استراتيجية preprint مقابل المجلة", "الرد على مراجعة الأقران"]
  }]
}, {
  "id": "research",
  "emoji": "🔬",
  ...
  "tracks": [{
    ...
    "skills": ["صياغة الفرضية (قابلة للدحض ومحددة)", "تصميم تجارب الضبط", "حجم العينة والقوة الإحصائية", "قابلية إعادة الإنتاج والتكرار", "تحديد المتغيرات المربكة"]
  }, {
    ...
    "skills": ["استراتيجيات البحث المنهجي", "معايير الإدراج والاستبعاد", "تركيب الأدلة مقابل السرد", "تحديد فجوات البحث", "بناء إطار مفاهيمي"]
  }, {
    "name": "عرض البحث",
    ...
    "skills": ["بنية عرض Journal club", "صيغة حديث مختبري مدته 10-20 دقيقة", "تصميم ملصق مؤتمر", "التعامل مع الأسئلة تحت الضغط", "مبادئ سرد البيانات بصريًا"]
  }]
}];
function BioscienceFoundation() {
  ...
  const t = isAr ? arUI : {
    ...
    heroTitle: "The Complete Foundation",
    heroTitleAccent: "Every Graduate Student Needs",
    ...
    byDomain: "By Domain",
    weekPlan: "16-Week Plan",
    planTitle: "16-Week Progression Plan",
    ...
    domainAlloc: "Domain Time Allocation",
    resources: "Resources",
    skills: "Skills to Acquire",
    timeframe: "Timeframe",
    parallel: "Can be done in parallel with other tracks.",
    free: "FREE",
    paid: "PAID",
    open: "Open ↗",
    tracks: "tracks",
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      background: "#F8F7F4",
      color: "#1A1A2E",
      fontFamily: isAr ? "'Noto Kufi Arabic',sans-serif" : "'IBM Plex Sans',system-ui,sans-serif",
  ...
  }, t.heroTag), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontFamily: isAr ? "'Noto Kufi Arabic',sans-serif" : "'Playfair Display',Georgia,serif",
  ...
  }, t.heroTitle, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      color: "#10B981"
    }
  }, t.heroTitleAccent)), /*#__PURE__*/React.createElement("p", {
    style: {
    ...
    label: isAr ? "6 محاور" : "6 Domains",
    sub: isAr ? "من الأحياء الجزيئية إلى الذكاء الاصطناعي" : "Molecular Bio to AI"
  }, {
    label: isAr ? "18 مساراً" : "18 Tracks",
    sub: isAr ? "تقدم منظم" : "Structured progression"
  }, {
    label: isAr ? "54 مصدراً" : "54 Resources",
    sub: isAr ? "معظمها مجاني" : "Mostly free"
  }, {
    label: isAr ? "16 أسبوعاً" : "16 Weeks",
    sub: isAr ? "10-25 ساعة / أسبوع" : "10-25h / week"
    ...
    style: {
      fontFamily: isAr ? "'Noto Kufi Arabic',sans-serif" : "'Playfair Display',serif",
      fontSize: 20,
      fontWeight: 700,
      color: "white"
    }
  ...
  }, displayDomains.map(d => /*#__PURE__*/React.createElement("button", {
    key: d.id,
    className: "f-domain-tab" + (activeTab === d.id && view === "domains" ? " active" : ""),
    style: {
      "--ftc": d.color,
      "--ftbg": d.bg
    },
  ...
  }, d.emoji), /*#__PURE__*/React.createElement("span", null, d.title.split(" ").slice(0, 2).join(" "))))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6
    }
  }, /*#__PURE__*/React.createElement("button", {
    className: "f-view-btn" + (view === "domains" ? " active" : ""),
    onClick: () => setView("domains")
  }, t.byDomain), /*#__PURE__*/React.createElement("button", {
    className: "f-view-btn" + (view === "timeline" ? " active" : ""),
    onClick: () => setView("timeline")
  }, t.weekPlan)))), view === "timeline" && /*#__PURE__*/React.createElement("div", {
    className: "slide-up",
    style: {
      maxWidth: 1100,
      margin: "0 auto",
  ...
  }, t.planTitle), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#888",
      fontSize: 13,
      lineHeight: 1.6,
  ...
  }, t.planDesc), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    }, phase.range), /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: isAr ? "'Noto Kufi Arabic',sans-serif" : "'Playfair Display',serif",
        fontSize: 18,
        fontWeight: 700,
    ...
    }, phase.title), phase.items.map((item, j) => /*#__PURE__*/React.createElement("div", {
      key: j,
      style: {
        display: "flex",
  ...
  }, t.domainAlloc), domains.map((d, idx) => {
    ...
    }, d.emoji, " ", d.title.split(" ").slice(0, 3).join(" ")), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        height: 8,
        background: "#F0EEE9",
  ...
  }))), view === "domains" && activeDomain && /*#__PURE__*/React.createElement("div", {
    key: activeTab,
    className: "slide-up",
    style: {
      maxWidth: 1100,
    ...
    style: {
      ...
      padding: "28px 32px",
      marginBottom: 24,
      borderLeft: isAr ? "1.5px solid #E8E5DF" : `5px solid ${activeDomain.color}`,
      borderRight: isAr ? `5px solid ${activeDomain.color}` : "1.5px solid #E8E5DF"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, activeDomain.emoji), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    style: {
      background: LEVELS[activeDomain.level].color + "18",
      color: LEVELS[activeDomain.level].color,
      border: `1px solid ${LEVELS[activeDomain.level].color}35`,
      borderRadius: 4,
      padding: "2px 9px",
      fontSize: 10,
      fontFamily: "'IBM Plex Mono',monospace",
  ...
  }, LEVELS[activeDomain.level].label), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: isAr ? "'Noto Kufi Arabic',sans-serif" : "'Playfair Display',serif",
      fontSize: 26,
      fontWeight: 700,
  ...
  }, activeDomain.title), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
  ...
  }, activeDomain.subtitle))), /*#__PURE__*/React.createElement("p", {
    style: {
      color: "#666",
      fontSize: 13,
      lineHeight: 1.7,
  ...
  }, activeDomain.description)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    val: activeDomain.tracks.length,
    label: t.tracks
  }, {
    val: activeDomain.tracks.reduce((a, tr) => a + tr.resources.length, 0),
    label: t.resW
  }, {
    val: activeDomain.tracks.reduce((a, tr) => a + tr.skills.length, 0),
    label: t.skillsW
  }, {
    val: activeDomain.tracks.filter(tr => tr.resources.some(r => r.free)).length,
    label: t.tracksF
  }].map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      background: activeDomain.bg,
      border: `1px solid ${activeDomain.border}`,
      borderRadius: 8,
      padding: "12px 16px",
      textAlign: "center",
      minWidth: 80
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      className: "f-track-card" + (isOpen ? " open" : ""),
      style: {
        "--fdc": activeDomain.color
      },
      onClick: () => setExpandedTrack(isOpen ? null : i)
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "space-between",
      ...
      style: {
        ...
        height: 36,
        background: activeDomain.bg,
        border: `1.5px solid ${activeDomain.border}`,
        borderRadius: 9,
        display: "flex",
        alignItems: "center",
    ...
    }, track.timeframe), /*#__PURE__*/React.createElement("span", {
      style: {
        width: 3,
        height: 3,
        background: "#D0CCC6",
    ...
    }, track.effort)))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "center",
        gap: 10
    ...
    }, track.resources.length, " resources \xB7 ", track.skills.length, " skills"), /*#__PURE__*/React.createElement("div", {
      style: {
        width: 26,
        height: 26,
        background: isOpen ? activeDomain.color : "#F0EEE9",
        border: `1.5px solid ${isOpen ? activeDomain.color : "#E8E5DF"}`,
        borderRadius: 6,
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
    ...
    }, t.resources), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 10
      }
    }, track.resources.map((r, j) => /*#__PURE__*/React.createElement("div", {
      key: j,
      className: "f-res-card"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "space-between",
      ...
      className: "f-badge",
      style: {
        background: r.free ? "#10B98118" : "#FFF4E5",
        color: r.free ? "#10B981" : "#F59E0B",
        border: `1px solid ${r.free ? "#10B98130" : "#F59E0B30"}`
      }
    }, r.free ? t.free : t.paid), /*#__PURE__*/React.createElement("span", {
      className: "f-badge",
      style: {
        background: "#F0EEE9",
        color: "#888",
    ...
    }, t.open))))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "#AAA",
        textTransform: "uppercase",
    ...
    }, track.skills.map((s, j) => /*#__PURE__*/React.createElement("span", {
      key: j,
      className: "f-skill-tag"
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        color: activeDomain.color,
        marginRight: 5,
    ...
    }, t.timeframe), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: "#666",
        lineHeight: 1.6
    ...
    }, track.timeframe), " at ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: "#333"
      }
    }, track.effort), ".", /*#__PURE__*/React.createElement("br", null), t.parallel))))));
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#1A1A2E",
      padding: "32px 40px",
  ...
  }, t.footerTitle), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: "rgba(255,255,255,0.35)",
      fontFamily: "'IBM Plex Mono',monospace"
    }
  }, t.footerSub)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 16,
      flexWrap: "wrap"
...
try {
  ReactDOM.createRoot(document.getElementById('foundation-root')).render(/*#__PURE__*/React.createElement(BioscienceFoundation, null));
} catch (e) {
